...
def test_chat_config_allows_classroom_presentation_hint() -> None:
    validate_chat_request_config({"classroom_mode": True})
    validate_capability_config("chat", {"classroom_mode": True})
